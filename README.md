...
이번 달 수입, 지출, 순잔액과 최근 내역, 분류별 사용 흐름을 한 화면에서 빠르게 확인할 수 있습니다.

![MoneyLog 대시보드](./docs/screenshots/dashboard.png)

### 거래 목록

월, 분류, 구분, 메모 조건으로 거래를 필터링하면서 전체 흐름과 합계를 함께 볼 수 있습니다.

![MoneyLog 거래 목록](./docs/screenshots/transactions.png)
